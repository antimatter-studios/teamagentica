...
const emptyForm = { name: "", text: "", type: "repeat" as const, triggerType: "timer" as "timer" | "event", schedule: "", eventPattern: "" };
...
export default function CronScheduler() {
  ...
  useEffect(() => {
    const cronEvents = sseEvents.filter((e) => e.event_type === "cron:fired");
    if (cronEvents.length > 0) refresh();
  }, [sseEvents, refresh]);
