...
func (t *Tracker) Summary() map[string]interface{} {
	...
	return map[string]interface{}{
		"today":    map[string]interface{}{"requests": todayReqs},
		"all_time": map[string]interface{}{"requests": totalReqs, "completed": completedReqs, "failed": failedReqs},
		"models":   modelCounts,
	}
}
...
func (t *Tracker) filePath() string { return filepath.Join(t.dataPath, usageFile) }
