...
func TestRecordAndRetrieve(t *testing.T) {
	...
	if records[0].Model != "gemini-2.5-flash-image" {
		t.Errorf("expected model gemini-2.5-flash-image, got %s", records[0].Model)
	}
...
func TestSummary(t *testing.T) {
	...
	if models["gemini-2.5-flash-image"] != 2 {
		t.Errorf("expected gemini-2.5-flash-image count 2, got %d", models["gemini-2.5-flash-image"])
	}
}
