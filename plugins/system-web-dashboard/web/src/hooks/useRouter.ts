...
export type Page = "dashboard" | "chat" | "code" | "files" | "tasks" | "scheduler" | "agents" | "marketplace" | "plugins" | "costs" | "console" | "users" | "memory" | "themes";

const VALID_PAGES = new Set<Page>([
  "dashboard", "chat", "code", "files", "tasks", "scheduler",
  "agents", "marketplace", "plugins", "costs", "console", "users", "memory", "themes",
]);
