...
func TestRecordRequestStores(t *testing.T) {
	...
	if records[0].Model != "google/gemini-2.5-flash" {
		t.Errorf("expected model google/gemini-2.5-flash, got %s", records[0].Model)
	}
...
func TestSummaryAggregation(t *testing.T) {
	...
	if models["google/gemini-2.5-flash"] != 1 {
		t.Errorf("expected 1 google/gemini-2.5-flash, got %d", models["google/gemini-2.5-flash"])
	}
	if models["openai/gpt-4o"] != 1 {
		t.Errorf("expected 1 openai/gpt-4o, got %d", models["openai/gpt-4o"])
	}
}
